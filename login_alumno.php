...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // El 'name' del input de usuario es 'usuario'
    $usuario = filter_input(INPUT_POST, 'usuario', FILTER_SANITIZE_STRING);
    // El 'name' del input de contraseña es 'contrasena'
    ...
    if ($result->num_rows == 1) {
        ...
        // La lógica de Alumno está intacta
        if ($row['tipo'] == 'Alumno') {
            ...
            // Redirige al dashboard de alumno
            echo "<script>window.location.href = 'dashboard_alumno.php';</script>";
            exit(); 
        
        } else {
          
            $error_message = "Acceso denegado. Esta sección es solo para Alumnos.";
        }
    ...
    <div class="row g-0"> 
      ...
      <div class="col-12 col-md-6 py-5 px-3 d-flex flex-column justify-content-center">
        <div class="text-center mb-4">
          ...
          <h2 style="color: #144d83; font-size: 1.2rem;">Alumno</h2>
        </div>
