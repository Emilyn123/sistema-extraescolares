...
<head>
	...
	<script src="js/funciones_asig.js?v=<?php echo time(); ?>"></script> 
...
<nav class="navbar navbar-expand-lg main-navbar" data-bs-theme="dark">
  <div class="container-fluid">
    ...
    <a class="navbar-brand d-flex align-items-center" href="index_asig.php"> <img src="logo1.png" alt="Logo" style="height: 65px; margin-right: 15px;">
      <div>
    ...
    <div class="collapse navbar-collapse" id="navbarPrincipal">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="index_asig.php">Asignar Puntos</a>
        </li>
        <li class="nav-item">
...
<main>
	<div id="buscador">
		<?php include_once 'componentes/id_asig.php'; ?>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="frmnuevo"> 
						...
						<div id="resultado_id_asignacion" style="margin-bottom: 15px; border: 1px solid #ccc; padding: 10px; border-radius: 5px; background-color: #f9f9f9; display: none;">
    					<label style="font-weight: bold;">ID de Asignación Asignada:</label>
    					<input type="text" name="id_asignacion" id="id_asignacion_modal" class="form-control">
						</div>
						...
						<label>Puntos</label>
						<input type="text" name="puntos" id="puntos_n" class="form-control">
					</form>
				</div>
...
<input type="text" name="" id="id_asignacion_u" class="form-control" readonly>
					...
					<label>Puntos</label>
					<input type="text" name="" id="puntos_u" class="form-control">
				</div>
				<div class="modal-footer">
...
<script type="text/javascript">
	// En el <script type="text/javascript"> de index_asig.php
function agregardatosSerializados(datos) {
    $.ajax({
        type: "POST",
        url: "php/agregarDatos_asigtal.php", // Asegúrate que esta ruta es correcta
        data: datos,
        success: function(id_generada){
    		var respuesta = String($.trim(id_generada));
            
            if (parseInt(respuesta) > 0 ){
                // Éxito: Muestra la ID generada por el servidor
              
                
                alertify.success("Asignación de puntos registrada con éxito. ID: " + respuesta); 
                
                // ... (Recarga de tabla y reset de formulario)
                ...
                // Error 
                alertify.error("Error al registrar la asignación de puntos." + id_generada);
                $('#resultado_id_asignacion').hide();
            }
        }
    });
}

// Y asegúrate de resetear y ocultar el mensaje al abrir el modal
