...
header("Expires: 0");
if (!isset($_SESSION['id_perfil']) || $_SESSION['tipo_usuario'] !== 'Alumno') {
    // Redirección original (si no es Alumno, lo saca)
    header("Location: login_tallerista.php"); // (O login_alumno.php si prefieres)
    exit;
}
...
<nav class="navbar navbar-expand-lg main-navbar" data-bs-theme="dark">
  <div class="container-fluid">
    ...
    <a class="navbar-brand d-flex align-items-center" href="#"> <img src="logo1.png" alt="Logo" style="height: 65px; margin-right: 15px;">
      <div>
        <span class="navbar-title">Panel de Alumno</span>
...
<main>
  <div class="content-box">
    ...
    <div class="dashboard-grid">
        ...
        <a href="index_cons.php" class="dashboard-button">
            <i class="icon bi bi-person-lines-fill"></i>
            <h2>Consultar Mi Historial</h2>
            <p>Ver mis actividades registradas y puntos acumulados.</p>
        </a>
