...
<head>
	...
	<title>Gestión de Registro de Alumnos</title>
	...
	<script src="js/funciones_reg.js?v=<?php echo time(); ?>"></script> 
...
<nav class="navbar navbar-expand-lg main-navbar" data-bs-theme="dark">
  <div class="container-fluid">
    ...
    <a class="navbar-brand d-flex align-items-center" href="index_reg.php"> <img src="logo1.png" alt="Logo" style="height: 65px; margin-right: 15px;">
      <div>
    ...
    <div class="collapse navbar-collapse" id="navbarPrincipal">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="index_reg.php">Registrar Alumno</a>
        </li>
        <li class="nav-item">
...
<main>
	<div id="buscador">
		<?php include_once 'componentes/mat_reg.php'; ?>
    </div>

	<div class="content-box">
		<h2>Gestión de Registro de Alumnos</h2>
		<div id="tabla"></div>
	</div>
</main>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="frmnuevo"> 
						...
						<label style="font-weight: bold;">ID de Registro Asignada:</label><p id="id_asignado_mostrar" class="form-control-plaintext" style="font-size: 1.1em; color: #2766a1ff; margin-bottom: 0;"></p></div>
    ...
    <p id="id_asignado_mostrar" class="form-control-plaintext" style="font-size: 1.1em; color: #2766a1ff; margin-bottom: 0;"></p>
					...
					<label>Semestre</label>
					<select name="" id="semestre_u" class="form-control">
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
						<option value="4">4</option>
...
<script type="text/javascript">
    ...
    $.ajax({
        type: "POST",
        url: "php/agregarDatos_reg.php", // Asegúrate de que esta ruta sea correcta
        data: datos,
        success: function(r){
            ...
            if (id_generada > 0){
                ...
                // Recargar la tabla (Ajusta la ruta si es necesario, ej: 'componentes/tabla_reg.php')
    ...
    $(document).ready(function(){
        ...
        // 1. LÓGICA DE CARGA DE TABLA Y FILTRO
