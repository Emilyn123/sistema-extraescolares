...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // El 'name' del input de contraseña debe ser 'contrasena'
    ...
    if ($result->num_rows == 1) {
        ...
        if ($row['tipo'] == 'Administrador') {
            ...
            $error_message = "Acceso denegado. Esta sección es solo para Administradores.";
        }
    ...
    <div class="row g-0"> 
      ...
      <div class="col-12 col-md-6 py-5 px-3 d-flex flex-column justify-content-center">
        <div class="text-center mb-4">
          ...
          <h2 style="color: #144d83; font-size: 1.2rem;">Administrador</h2>
        </div>
