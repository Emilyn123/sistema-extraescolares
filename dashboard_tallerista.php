...
header("Expires: 0");
if (!isset($_SESSION['id_perfil']) || $_SESSION['tipo_usuario'] !== 'Tallerista') {
    header("Location: login_tallerista.php");
    exit;
}
...
<head>
  ...
  <style>
    ...
    /* Estilos para .dashboard-grid (del nuevo diseño, centrado) */
    .dashboard-grid {
      display: grid; 
      grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));
      gap: 30px; 
      /* Centramos la grid si solo hay 2 elementos en pantallas anchas */
      justify-content: center;
      max-width: 600px; /* Ancho máximo para 2 columnas */
      margin: 0 auto; /* Centrar el grid */
    }
    
    /* Estilos para .dashboard-button (Fusionados) */
    .dashboard-button {
...
<main>
  <div class="content-box">
    ...
    <div class="dashboard-grid">
        ...
        <a href="index_regtal.php" class="dashboard-button">
            <i class="icon bi bi-person-plus-fill"></i>
            <h2>Agregar Alumno</h2>
            <p>Ingresar datos de un nuevo estudiante.</p>
        </a>

        <a href="index_asigtal.php" class="dashboard-button">
